...
export const environment = {
  ...
  site: 'site13',
  apiGatewaySettings: {
    endpointUrl: 'https://edge.hedge.earth/emissionless/rollthecloudinc/site13-objects-prod/shapeshifter',
  },
  mediaSettings: {
    ...
    imageUrl: 'https://edge.hedge.earth/emissionless/site13',
  ...
  panelsSettings: {
    ...
    objectsRootUrl: 'https://rollthecloudinc.github.io/site13-objects-prod'
  },
  alienaliasSettings: {
    openSearchDomain: 'search-classifieds-ui-prod-o5unofrr3c4qb3ykfrxebh2e4a'
  },
  ...
  clientSettings: {
    ...
    redirect_uri: 'https://site13.druidcloud.io/auth-callback',
    silent_redirect_uri: 'https://site13.druidcloud.io/silent-refresh.html',
    response_type: "code",
