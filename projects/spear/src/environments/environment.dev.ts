...
export const environment = {
  ...
  apiGatewaySettings: {
    ...
    endpointUrl: "https://vertigo.druidcloud.dev/rollthecloudinc/site13-objects/shapeshifter"
  },
  mediaSettings: {
    endpointUrl: 'https://vertigo.druidcloud.dev/site13/media',
    cloudinaryUrl: 'https://api.cloudinary.com/v1_1/dj4vvkgzw',
    uploadPreset: 'i0hm4opm',
    imageUrl: 'https://vertigo.druidcloud.dev/site13',
  ...
  panelsSettings: {
    ...
    objectsRootUrl: 'https://rollthecloudinc.github.io/site13-objects'
  },
  alienaliasSettings: {
    openSearchDomain: 'search-classifieds-ui-dev-eldczuhq3vesgpjnr3vie6cagq'
  },
  ...
  clientSettings: {
    ...
    redirect_uri: 'https://site13.druidcloud.dev/auth-callback',
    silent_redirect_uri: 'https://site13.druidcloud.dev/silent-refresh.html',
    response_type: "code",
